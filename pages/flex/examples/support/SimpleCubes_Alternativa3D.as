package examples.support {
	...
	import com.transmote.flar.utils.FLARAlternativaGeomUtils;
	...
	import org.libspark.flartoolkit.alternativa3D.FLARCamera3D;
	...
	public class SimpleCubes_Alternativa3D extends Sprite {
		...
		public function SimpleCubes_Alternativa3D (numPatterns:uint, cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) {
			...
			this.initAlternativa3DEnvironment(cameraParams, mirrorDisplay, viewportWidth, viewportHeight);
		}
		...
		private function initAlternativa3DEnvironment (cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) :void {
		...
		private function applyTransform (obj:Object3D, transmat:FLARDoubleMatrix34) :void {
			...
			var m:Matrix3D = FLARAlternativaGeomUtils.convertFLARMatrixToAlternativaMatrix(transmat);
