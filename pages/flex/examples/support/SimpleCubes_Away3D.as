package examples.support {
	...
	import com.transmote.flar.utils.FLARAwayGeomUtils;
	...
	public class SimpleCubes_Away3D extends Sprite {
		...
		public function SimpleCubes_Away3D (numPatterns:uint, cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) {
			...
			this.initAway3DEnvironment(cameraParams, mirrorDisplay, viewportWidth, viewportHeight);
		}
		...
		private function initAway3DEnvironment (cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) :void {
		...
		private function updateCubes () :void {
			...
			while (i--) {
				...
				while (j--) {
					...
					container.transform = FLARAwayGeomUtils.convertFLARMatrixToAwayMatrix(marker.transformMatrix);
				}
			}
		}
