package examples.support {
	...
	import com.transmote.flar.utils.FLARSandyGeomUtils;
	...
	import org.libspark.flartoolkit.sandy3D.FLARCamera3D;
	...
	public class SimpleCubes_Sandy3D extends Sprite {
		...
		public function SimpleCubes_Sandy3D (numPatterns:uint, cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) {
			...
			this.initSandy3DEnvironment(cameraParams, mirrorDisplay, viewportWidth, viewportHeight);
		}
		...
		private function initSandy3DEnvironment (cameraParams:FLARParam, mirrorDisplay:Boolean, viewportWidth:Number, viewportHeight:Number) :void {
		...
		private function updateCubes () :void {
			...
			while (i--) {
				...
				while (j--) {
					...
					container.matrix = FLARSandyGeomUtils.convertFLARMatrixToSandyMatrix(marker.transformMatrix);
				}
			}
		}
